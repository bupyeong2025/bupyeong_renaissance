...
export default function Banner({ isLoaded }: BannerProps) {
  return (
    <div
      className={`relative z-10 px-4 pt-[clamp(181px,56.6vw,232px)] transition-all duration-700 delay-700 ${
    ...
    >
      <div className="backdrop-blur-md bg-white/70 rounded-xl border-[2.67px] border-white shadow-xl p-6 hover:shadow-2xl transition-shadow">
        <h1 className="text-[clamp(22px,7.07vw,29px)] font-bold leading-[clamp(32px,10vw,41px)] text-[#333333]">
          <span>부평</span>
